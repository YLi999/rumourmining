...
get_ipython().magic('run "Omar Thesis-10A.ipynb"')
...
get_ipython().magic('run getScoreB.py')

def getGoldResultsScoreB(name,classifier):
    ...
    print( name + ' score: ' + str(getScoreB(SubTaskBGoldFilePath,SubTaskBGoldResultsFilePath)))
    
show_details = True
    
if show_details == True:
    getGoldResultsScoreB('Random Forest',randomForestClassifier)
    getGoldResultsScoreB('Logistic Regression',logisticRegressionClassifier)
    getGoldResultsScoreB('SVM',linearSVCClassifier)
    getGoldResultsScoreB('Neural Network',mlpClassifier)
    getGoldResultsScoreB('Gradient Boost',gradientBoostClassifier)
    getGoldResultsScoreB('Decision Tree Bagging',baggingClassifier)
    getGoldResultsScoreB('AdaBoost',adaBoostClassifier)
getGoldResultsScoreB('Voting',votingClassifier)
